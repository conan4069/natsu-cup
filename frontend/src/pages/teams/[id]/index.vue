        ...
        <v-col cols="12" md="6">
          <v-card rounded="xl">
            ...
            <v-card-text>
              ...
              <div class="mb-4">
                <div class="mb-3">
                  <span class="text-body-2 text-grey-darken-1">Nombre:</span>
                  <div class="font-weight-medium">{{ team.name }}</div>
                </div>
                <div v-if="team.logo" class="mb-3">
                  <span class="text-body-2 text-grey-darken-1">Logo:</span>
                  <div class="mt-2">
                    <v-avatar size="60">
                      <v-img :src="team.logo" alt="Logo del equipo" />
                    </v-avatar>
                  </div>
                </div>
                <div class="mb-3">
                  <span class="text-body-2 text-grey-darken-1">ID del equipo:</span>
                  <div class="font-weight-medium">{{ team.id }}</div>
                </div>
              </div>
            </v-card-text>
            <v-card-actions>
